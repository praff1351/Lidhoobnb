  ...
  return (
    ...
    <div className="mb-4">
      ...
      >
        ...
        <option value="Cottage">Cabin or Cottage</option>
    ...
    <div>
      <button
        className="bg-slate-500 hover:bg-slate-600 text-white font-bold py-2 px-4 rounded-full w-full focus:outline-none focus:shadow-outline disabled:opacity-50 disabled:cursor-not-allowed"
        type="submit"
        disabled={isPending}
      >
